...
func (*PBLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_e130bb98ab831152, []int{0}
}
...
func (*PBNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_e130bb98ab831152, []int{1}
}
...
func (m *PBNode) GetBlockInfo() uint64 {
...
func init() { proto.RegisterFile("pb/merkledag.proto", fileDescriptor_e130bb98ab831152) }

var fileDescriptor_e130bb98ab831152 = []byte{
	// 266 bytes of a gzipped FileDescriptorProto
	,
	...
	0x18, 0x25, 0xa8, 0xa7, 0x5f, 0x90, 0x64, 0x0d, 0x77, 0x40, 0x7c, 0x41, 0x12, 0x20, 0x00, 0x00,
	0xff, 0xff, 0xfc, 0x07, 0xd8, 0x25, 0x49, 0x01, 0x00, 0x00,
}
...
func (this *PBNode) VerboseEqual(that interface{}) error {
	...
	if this.BlockInfo != nil && that1.BlockInfo != nil {
		if *this.BlockInfo != *that1.BlockInfo {
			return fmt.Errorf("BlockInfo this(%v) Not Equal that(%v)", *this.BlockInfo, *that1.BlockInfo)
		}
	} else if this.BlockInfo != nil {
		return fmt.Errorf("this.BlockInfo == nil && that.BlockInfo != nil")
	} else if that1.BlockInfo != nil {
		return fmt.Errorf("BlockInfo this(%v) Not Equal that(%v)", this.BlockInfo, that1.BlockInfo)
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return fmt.Errorf("XXX_unrecognized this(%v) Not Equal that(%v)", this.XXX_unrecognized, that1.XXX_unrecognized)
...
func (this *PBNode) GoString() string {
	...
	if this.BlockInfo != nil {
		s = append(s, "BlockInfo: "+valueToGoStringMerkledag(this.BlockInfo, "uint64")+",\n")
	}
	if this.XXX_unrecognized != nil {
		s = append(s, "XXX_unrecognized:"+fmt.Sprintf("%#v", this.XXX_unrecognized)+",\n")
	}
...
func (m *PBNode) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.BlockInfo != nil {
		i = encodeVarintMerkledag(dAtA, i, uint64(*m.BlockInfo))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Links) > 0 {
...
func randFieldMerkledag(dAtA []byte, r randyMerkledag, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateMerkledag(dAtA, uint64(v8))
	case 1:
		dAtA = encodeVarintPopulateMerkledag(dAtA, uint64(key))
...
func (m *PBNode) Size() (n int) {
	...
	if m.BlockInfo != nil {
		n += 1 + sovMerkledag(uint64(*m.BlockInfo))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (this *PBNode) String() string {
	...
	s := strings.Join([]string{`&PBNode{`,
		...
		`BlockInfo:` + valueToStringMerkledag(this.BlockInfo) + `,`,
		`XXX_unrecognized:` + fmt.Sprintf("%v", this.XXX_unrecognized) + `,`,
		`}`,
	}, "")
	return s
